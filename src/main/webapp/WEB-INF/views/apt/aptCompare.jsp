...
<body>
	...
	<div class="container"
		style="height: 720px; margin-top: 70px; text-align: center; border: 1px solid #ccc; border-radius: 25px; box-shadow: 1px 2px 2px 2px gray;">
		<div style="margin-bottom: 50px; margin-top: 30px;">
			<span style="font-size: 30px; font-weight: bold;">내 아파트 비교하기</span> <br> <br>
			<hr>
		</div>
								...
								<div class="row row-cols-4 border align-middle"
									...
									<div
										...
										<select class="form-select"
											aria-label="Default select example" id="gu">
									...
									<div
										class="col border d-flex align-items-center justify-content-center">
										<select class="form-select"
											aria-label="Default select example" id="dong">
									...
									<div
										class="col border d-flex align-items-center justify-content-center">
										<select class="form-select"
											aria-label="Default select example" id="apart">
